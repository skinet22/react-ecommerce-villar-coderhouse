    ...
    return (
        <div className="row">
            ...
            <div className="col-lg-6 pb-2">
                {Count<=stock ? <button className="btn btn-danger w-100" onClick={()=>onAdd(Count)}>Agregar al carrito</button>: <button className="btn btn-primary" disabled>Agregar al carrito</button>}
            </div>
        </div>
    )
}
